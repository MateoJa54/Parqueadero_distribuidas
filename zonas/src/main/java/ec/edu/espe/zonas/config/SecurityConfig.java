 ...
 *   <li>Toda peticion exige un access token valido emitido por usuarios.</li>
 *   <li>La autorizacion FINA por rol (ADMIN/ROOT para mutaciones) se declara con
 *       {@code @PreAuthorize} en los controladores.</li>
