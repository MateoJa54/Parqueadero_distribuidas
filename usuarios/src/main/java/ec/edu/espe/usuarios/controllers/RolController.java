...
public class RolController {
    ...
    public ResponseEntity<RolResponseDto> activarRol(@PathVariable UUID idRol) {
        return ResponseEntity.ok(rolServicio.activarRol(idRol));
    }

    @PatchMapping("/{idRol}/desactivar")
    public ResponseEntity<RolResponseDto> desactivarRol(@PathVariable UUID idRol) {
        return ResponseEntity.ok(rolServicio.desactivarRol(idRol));
    }
}
